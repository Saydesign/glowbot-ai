...
export function CartDrawer({ isOpen, onClose, customerName, onOrderComplete }: CartDrawerProps) {
  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      {/* FIX: h-full dengan overflow hidden di container utama */}
      <div className="absolute right-0 top-0 h-full w-full max-w-md bg-white shadow-xl flex flex-col overflow-hidden">
        
        {/* Header — fixed di atas */}
        <div className="flex-shrink-0 flex items-center justify-between p-4 border-b border-pink-100 bg-white">
        ...
        {step === 'cart' && (
          <div className="flex-1 flex flex-col min-h-0">
            ...
            {/* FIX: Footer sticky di bawah */}
            {items.length > 0 && (
              <div className="flex-shrink-0 border-t border-pink-100 p-4 space-y-3 bg-white">
        ...
        {step === 'checkout' && (
          <form onSubmit={handleSubmitOrder} className="flex-1 flex flex-col min-h-0">
            ...
            {/* FIX: Tombol sticky di bawah, selalu kelihatan */}
            <div className="flex-shrink-0 p-4 border-t border-pink-100 space-y-2 bg-white">
        ...
        {step === 'success' && (
          <div className="flex-1 flex flex-col items-center justify-center p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">Detail pesanan sudah terkirim ke chat kamu.</p>
